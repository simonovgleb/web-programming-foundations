...
function addDemoRequestCard(demoRequest) {
	...
	productsList.textContent = demoRequest.products.join(", ");
	...
	timestamp.textContent = demoRequest.timestamp.toLocaleString(DEFAULT_LOCALE, { ...DATE_FORMAT_OPTIONS, ...TIME_FORMAT_OPTIONS });
